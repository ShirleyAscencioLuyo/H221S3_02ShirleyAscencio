...
<div class="container">
		...
		<div class="row mt-3">
			<div class="col-md-5">
				<div class="input-group mb-3">
					...
					<input type="search" class="form-control" placeholder="Buscar..." id="idBuscarAdministrador">
				</div>
			</div>
	...
	<div class="my-3 p-3 bg-body rounded shadow-sm">
		<table class="table table-sm table-hover" id="tablaAdministrative">
			<thead>
			<tr>
				<th scope="col">ID</th>
	...
	<div class="modal fade" id="administradorModal" tabindex="-1"
		 aria-labelledby="administradorModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="administradorModalLabel">Crear nuevo
						estudiante</h5>
				...
				<div class="modal-body">
					...
					<form class="row g-2" id="formAdministrador">
						...
						<div class="col-md-12 input-group-sm">
							<label for="frmEmail" class="form-label">Email:</label> <input
								type="text" class="form-control" id="frmEmail" required>
							<div id="errorEmail" class="error-messageT1"></div>
						...
						<div class="col-md-4 input-group-sm">
							<label for="frmTipoCargo" class="form-label">Tipo Cargo:</label> 
							<select class="form-select" aria-label="Seleccionar" id="frmTipoCargo">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary"
							data-bs-dismiss="modal" id="btnCancelarAdministrador">Cancelar</button>
					<button type="submit" class="btn btn-primary"
							id="btnGuardarAdministrador" disabled>Guardar</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="confirmacionModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ¿Estas seguro de desactivar a este Administrador?
	      </div>
	      <div class="modal-footer">
...
<script type="text/javascript" src="js/administrative.js"></script>
<script type="text/javascript" src="js/administrativeExports.js"></script>
<script type="text/javascript" src="js/administrativeValidation.js"></script>
